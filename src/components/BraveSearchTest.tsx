...
export default function BraveSearchTest() {
  ...
  const handleTest = async () => {
    ...
    try {
      ...
      // Use the public checkConfiguration method
      ...
      const testCase: BusinessCase = {
        ...
        industry: 'Technology & Software' as Industry, // Type assertion to Industry
        capex: 1000000,
        opex: 500000,
      ...
      const searchResults = await agent.searchMarketInsights(testCase);
